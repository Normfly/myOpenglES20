...
public class GraphicTools {
    ...
    public static String vs_Image_Lighting_Bump;
    public static String fs_Image_Lighting_Bump;
   ...
   /* //fragment shader with texture and alpha channel
    ...
    public static void ReadShaderText(Context context){
       ...
       //vs_Image_Lighting_Bump = ReadTextFileFromResource(context, R.raw.vertex_shader_image_lighting);
       //fs_Image_Lighting_Bump = ReadTextFileFromResource(context, R.raw.fragment_shader_image_lighting);
